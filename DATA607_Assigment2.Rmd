...
[Link to Github](https://github.com/GabrielSantos33/DATA607-Assignment-2/blob/main/Movie_data.sql)

An alternate way is to upload the data set to MySQL through R.
```{r SQL Write SQL Table}
movies = read.csv("https://github.com/GabrielSantos33/DATA607-Assignment-2/blob/main/Movies.csv")
